<%@ Page Title="" Language="C#" MasterPageFile="~/AdminReports/AdminSite.master" AutoEventWireup="true" CodeFile="frmSendEmail_Reminder_InitiateYour360Degree_FeedbackForm_DeadlineExtension_Mail11.aspx.cs" EnableEventValidation="false" Inherits="frmSendEmailInvite" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="section-title clearfix">
        <h3 class="text-center">Reminder: Initiate Your 360-Degree Feedback Form | Deadline extension</h3>
