...
public partial class frmSendEmailInvite : System.Web.UI.Page
{
            ...
            List<SqlParameter> sp = new List<SqlParameter>()
              {
                   ...
                   new SqlParameter("@MailType", 11), //  Reminder: Initiate Your 360-Degree Feedback Form | Deadline extension // Mail Type 11
              };
    ...
    public static string fnSendICSFIleToUsers(string ParticipantID, string ParticipantName, string ParticipantEmpCode, string ParticipantEMailID, string ParticipantLevelID, string ParticipantUserType, string ParticipantUserName, string ParticipantPassword, string DeadlineDate)
    {
        ...
        try
        {
            ...
            msg.Subject = "Reminder: Initiate Your 360-Degree Feedback Form | Deadline extension";
            ...
            strBody.Append("<p>We heard you, we are extending the deadline to " + DeadlineDate + ", for you to initiate your 360 - Degree Feedback form.Your active participation is highly appreciated.</p>");
            strBody.Append("<p>To know more about the survey, access the : <a href='https://apcdeloitte.sharepoint.com/sites/in/psupport/hr/Pages/360-Degree-Framework-Toolkit.aspx'>360 Feedback Toolkit</a></p>");
    ...
    public static void fnUpdateMailSp(string SPName, string EmpNodeID, string FlgMailState, string flgUpdate, string UserType, SqlConnection Scon1)
    {
        ...
        Scmd.Parameters.AddWithValue("@MailType", 11);
