...
public partial class frmSendEmailInvite : System.Web.UI.Page
{
            ...
            List<SqlParameter> sp = new List<SqlParameter>()
              {
                   ...
                   new SqlParameter("@MailType", 6), //  Reminder: Initiate Your 360-Degree Feedback Form // Mail Type 6
              };
    ...
    public static string fnSendICSFIleToUsers(string ParticipantID, string ParticipantName, string ParticipantEmpCode, string ParticipantEMailID, string ParticipantLevelID, string ParticipantUserType, string ParticipantUserName, string ParticipantPassword, string DeadlineDate)
    {
        ...
        try
        {
            ...
            msg.Subject = "Reminder: Initiate Your 360-Degree Feedback Form";
            ...
            strBody.Append("<p>Your 360-Degree Feedback Form 2024–25 is now available at the following URL: <a href=" + WebSitePath + ">" + WebSitePath + "</a></p>");
            ...
            strBody.Append("<p>The way forward involves triggering a process, where the selected list of participants will provide feedback through this tool. You can login to the platform via Single Sign On (SSO) using your Deloitte credentials through the following URL: (platform URL will come later).</p>");
