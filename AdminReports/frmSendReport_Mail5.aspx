<%@ Page Title="" Language="C#" MasterPageFile="~/AdminReports/AdminSite.master" AutoEventWireup="true" CodeFile="frmSendReport_Mail5.aspx.cs" EnableEventValidation="false" Inherits="frmSendEmailInvite" %>
    ...
    <script>
        ...
        function fnSave(flg) {
            ...
            $("#MainContent_divdrmmain").find("#tbldbrlist input[flg=1]:checked").each(function () {
                ...
                var ReportFileName = $(this).closest("tr").attr("ReportFileName");
                var ManagerMailId = $(this).closest("tr").attr("ManagerMailId");

                

                ArrDataSaving.push({ ParticipantID: ParticipantID, ParticipantName: ParticipantName, ParticipantEMailID: ParticipantEMailID, MailStatus: '', ParticipantUserName: ParticipantUserName, ParticipantPassword: ParticipantPassword, DeadlineDate: DeadlineDate, ReportFileName: ReportFileName, ManagerMailId: ManagerMailId });
            });
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="section-title clearfix">
        <h3 class="text-center">360 Degree Feedback for your stakeholders: Survey completion : Report Sent</h3>
