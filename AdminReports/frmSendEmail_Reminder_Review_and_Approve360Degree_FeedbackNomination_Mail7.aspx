<%@ Page Title="" Language="C#" MasterPageFile="~/AdminReports/AdminSite.master" AutoEventWireup="true" CodeFile="frmSendEmail_Reminder_Review_and_Approve360Degree_FeedbackNomination_Mail7.aspx.cs" EnableEventValidation="false" Inherits="frmSend_Review_Approve_Email_ToManager" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="section-title clearfix">
        <h3 class="text-center">Reminder: Review and Approve 360-Degree Feedback Nomination</h3>
