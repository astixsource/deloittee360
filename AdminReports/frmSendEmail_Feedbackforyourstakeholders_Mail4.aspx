<%@ Page Title="" Language="C#" MasterPageFile="~/AdminReports/AdminSite.master" AutoEventWireup="true" CodeFile="frmSendEmail_Feedbackforyourstakeholders_Mail4.aspx.cs" EnableEventValidation="false" Inherits="frmSendEmailInvite" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="section-title clearfix">
        <h3 class="text-center">360 Degree Feedback for your stakeholders: Survey Launch</h3>
