...
public partial class AdminReports_frmNominationStatusReport : System.Web.UI.Page
{
    ...
    public static string GetDetails(string CycleId, string StatusID)
    {
        try
        {
            ...
            Scmd.CommandText = "spRptGetRaterWiseSurveyCompletionCount";
    ...
    protected void btnDownload_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            HttpContext.Current.Response.AddHeader("content-disposition", "attachment;filename=RaterWiseSurveyCompletionCountReport_" + DateTime.Now.ToString("yyyyMMddhhmmss") + ".xlsx");
