<%@ Page Title="" Language="C#" MasterPageFile="~/AdminReports/AdminSite.master" AutoEventWireup="true" CodeFile="frmSendEmail_KickOffNotice_Mail3.aspx.cs" EnableEventValidation="false" Inherits="frmSendEmailInvite" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="section-title clearfix">
        <h3 class="text-center">360 Degree Feedback Mail: Kickoff Notice </h3>
    ...
    <div class="row">
        ...
        <div class="col-md-2">
            <input type="button" id="btnShowUsers" value="Show Users" onclick="fnUserList()" class="btns btn-submit small">
        </div>
    </div>
