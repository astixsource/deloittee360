...
<script RunAt="server">
    ...
    void Application_Start(object sender, EventArgs e)
    {
        ...
        if (Application["DbConnectionString"] == null)
        {
            ...
            Application["AzureMailconnectionString"] ="endpoint=https://astixemailcommunication.india.communication.azure.com/;accesskey=eY/ca2ZawDDXmJx1KvbW0FXw5CbMmucrsW+mjBqE9urodCYTNJeiBeRq3vjX/s7cVlCymgjphLEPbeF9IJRSuw==";// secretClient.GetSecret("Secret-AzureMailconnectionString-Deloitte").Value.Value;
